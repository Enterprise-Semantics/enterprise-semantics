...
# Operations Profile Subdir (Reserved)

**Status:** Reserved at v0.0.1, no profile records landed yet.
**Profile family:** `operations`, enterprise operating model
...
This directory holds Operations-family profile records per CR-ES-001 §18. Profiles provide semantic organisation rather than independent authorities.
