...
# Enterprise Profile Subdir (Reserved)

**Status:** Reserved at v0.0.1 ;;; no profile records landed yet.
**Profile family:** `enterprise` ;;; 8 enterprise areas per CR-ES-AG-008
...
This directory holds Enterprise-family profile records per CR-ES-001 §18. Profiles provide semantic organisation rather than independent authorities.
