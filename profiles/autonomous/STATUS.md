...
# Autonomous Profile Subdir (Reserved)

**Status:** Reserved at v0.0.1, no profile records landed yet.
**Profile family:** `autonomous`, Profile family reserved per registry/profile-types.yaml (status: Reserved)
...
This directory holds Autonomous-family profile records per CR-ES-001 §18. Profiles provide semantic organisation rather than independent authorities.
